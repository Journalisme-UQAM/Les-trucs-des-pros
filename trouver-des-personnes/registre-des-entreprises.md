...
Le plus utile de tous les outils de recherche offerts gratuitement par l’État québécois est sans contredit le [**Registre des entreprises (REQ**](https://www.quebec.ca/entreprises-et-travailleurs-autonomes/obtenir-renseignements-entreprise/recherche-registre-entreprises/acceder-registre-entreprises)**)**. Il permet notamment de savoir à qui appartient une société ou qui administre un organisme sans but lucratif.

Il permet également, dans bien des cas, de connaître leur adresse personnelle. À la fois fantastique et troublant.
...
Il y a trois portes d'entrée pour faire des recherches dans le REQ.

### [Par nom d'organisation](https://www.registreentreprises.gouv.qc.ca/reqna/gr/gr03/gr03a71.rechercheregistre.mvc/gr03a71?choixdomaine=RegistreEntreprisesQuebec)

C'est le mode classique de recherche. Vous entrez le nom de l'entreprise ou de l'organisation qui vous intéresse et vous en avez les actionnaires et/ou les administrateurs.

### [Par nom d'individu](https://www.registreentreprises.gouv.qc.ca/REQNA/GR/GR03/GR03A71.RechercheRegistre.MVC/GR03A71/RechercheNomPrenom)

Nouveau mode accessible depuis juillet 2024! Il est possible de faire des recherche **par prénom et nom de famille**, ce qui facilite considérablement le travail des journalistes.

Si vous ne trouvez rien, pensez faire une recherche avec le nom des **personnes apparentées** (parents, enfants, conjoints) aux personnes qui vous intéressent.

### Recherche de plus vieilles entreprises
...
<figure><img src="../.gitbook/assets/FCE.png" alt=""><figcaption></figcaption></figure>

Au besoin, pour les cas où vous faites une longue enquête ou un documentaire, il est possible de demander des copies des [documents originaux](https://www.quebec.ca/entreprises-et-travailleurs-autonomes/obtenir-renseignements-entreprise/copie-document-certificat-registraire-entreprises) d'une entreprise qui contiennent parfois des renseignements intéressants.

***

### Registres canadiens des entreprises 🇨🇦
...
### Registres d'autres pays 🌍

La page Wikipedia des registres des entreprises dans le monde (en [anglais](https://en.wikipedia.org/wiki/List_of_official_business_registers)) peut vous être utile si vous vous intéressez à des sociétés basées ailleurs.

En France, l[**'INPI**](https://data.inpi.fr) vous permet d'obtenir des informations sommaires sur des sociétés établies dans l'Hexagone 🇫🇷, mais aussi sur des marques et des brevets (via Olivier Picard).

<figure><img src="../.gitbook/assets/inpi.png" alt="" width="173"><figcaption></figcaption></figure>

### OpenCorporates&#x20;

OpenCorporates était utile pour faire des **recherches inversées**, c'est-à-dire par nom d’actionnaire ou d’administrateur. Mais il est moins nécessaire d'y recourir depuis que cette option est disponible dans le REQ.
